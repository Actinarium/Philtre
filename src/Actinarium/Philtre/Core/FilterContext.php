...
{
    /**
     * Any FilterContext must implement this method so that Filters and ExecutionManagers can use it to check whether
     * the stream with given ID exists. Should return true or false.
     *
    ...
    /**
     * Any FilterContext must implement this method so that Filters and ExecutionManagers can use it to put data into
     * the context. Implementation is frivolous. Method should not return anything, but rather throw
    ...
    /**
     * Any FilterContext must implement this method so that Filters and ExecutionManagers can use it to get data from
     * the context. Implementation is frivolous. In case data cannot be retrieved, the method should throw
